...
### 8. Starter-kit templates

Run `agent_sync-skill-tables` to propagate any skill list changes to the starter-kit
templates and (if in a project) to the project's config files.
